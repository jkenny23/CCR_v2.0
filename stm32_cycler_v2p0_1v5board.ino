...
#define AC1T PA4 //Cell 1 temperature input
...
#define ABUFV PA0 //Buffer/input voltage input
...
#define OC1PF PA9 //Buck FET control output, positive logic; higher PWM duty = higher output voltage
...
#define OC1NF2 PA8 //CC 1 setting output
#define OC2NF2 PB7 //CC 2 setting output
#define C1DOFF PB12 //CC 1 disable output
#define C2DOFF PA15 //CC 2 disable output
#define C1ON PB14 //Cell 1 protection bypass
#define C2ON PB3 //Cell 2 protection bypass
#define FANON PB13 //Fan control output
#define WSDI PB5 //LED control pin, inverted logic
...
unsigned short getCell1RV(){
  return 0;//(int)(((float)analogRead(AC1R)) * VR12V);
}

unsigned short getCell2RV(){
  return 0;//(int)(((float)analogRead(AC2R)) * VR22V);
}
