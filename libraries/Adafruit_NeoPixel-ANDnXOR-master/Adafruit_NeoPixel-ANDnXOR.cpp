...
void Adafruit_NeoPixel::begin(void) {
  pinMode(pin, OUTPUT);
  digitalWrite(pin, HIGH); //Normally LOW for non-inverted logic
}
...
void Adafruit_NeoPixel::show(void) {
  ...
  #define SET_HI    (PIN_MAP[pin].gpio_device->regs->BSRR = (1U << PIN_MAP[pin].gpio_bit) << (16 *  ((uint8_t)!0)) ); //Normally !1 for non-inv logic
  #define SET_LO   (PIN_MAP[pin].gpio_device->regs->BSRR = (1U << PIN_MAP[pin].gpio_bit) << (16 *  ((uint8_t)!1)) ); //Normally !0 for non-inv logic
